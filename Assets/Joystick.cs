...
public class Joystick : MonoBehaviour, IDragHandler, IEndDragHandler
{
	...
	public virtual void OnDrag(PointerEventData eventData) // IDragHandler와 연결 
	{
		// 조이스틱 위치 조정
	...
	public virtual void OnEndDrag(PointerEventData eventData) //IEndDragHandler와 연결 → 조이스틱이 원래대로 돌아오도록
	{
		// 초기값으로 설정
